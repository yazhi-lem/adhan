...
print("   - Train: data/pre_training/tamil_texts/hf/train.jsonl (1,220 records)")
print("   - Val: data/pre_training/tamil_texts/hf/validation.jsonl (152 records)")
print("   - Test: data/pre_training/tamil_texts/hf/test.jsonl (154 records)")
