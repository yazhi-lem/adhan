...
def main():
    ...
    parser.add_argument(
        "--keywords",
        type=str,
        default="அரசியல்,வரலாறு,கல்வி,சமூகம்,கலாச்சாரம்,Politics,History,Education",
    )
    ...
    wiki = wikipediaapi.Wikipedia(
        ...
        user_agent="AdhanTamilCorpus/1.0",
    )
    ...
    for art in articles:
        ...
        for s in sents:
            sentences.append(
                {"text": scraper._clean_tamil_text(s), "source": "wikipedia", "url": art.get("url")}
            )
